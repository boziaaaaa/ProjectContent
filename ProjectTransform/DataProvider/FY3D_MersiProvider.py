...
class FY3D_MersiProvider(DataProvider):
    def __init__(self):
        super(FY3D_MersiProvider, self).__init__()
    ...
    def Dispose(self):
        ...
        self.__description = 'NULL'
        self.__obsDataCount = 0
        super(FY3D_MersiProvider, self).Dispose()
    ...
    def OnParametersUpdate(self):
        super(FY3D_MersiProvider, self).OnParametersUpdate()
    ...
    def GetOBSData(self, band):
        ...
        if bandname != '':
            ...
            if "Ref" in bandname:
               VIS_Cal_Coeff = self.__HdfFileHandleList['L1']['Calibration/VIS_Cal_Coeff'][:]
               print VIS_Cal_Coeff
    ...
    def GetDataSet(self, filehandle, group, ds):
        ...
        if "Latitude" in ds or "ongitude" in ds:
            ...
            data = self.__HdfOperator.ReadHdfDataset(filehandle, "Data", ds)
        print data.value
