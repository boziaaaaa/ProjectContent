...
class ProjProcessor(object):
    ...
    def CreateResultInfo(self):
        ...
        #self.__projResult.ResultInfo['VResolution'] = int(self.__ProjParam.ProjectResolution) yuanbo 20180827   
        self.__projResult.ResultInfo['UResolution'] = int(self.__ProjParam.ProjectResolution)/100000.0
        self.__projResult.ResultInfo['VResolution'] = int(self.__ProjParam.ProjectResolution)/100000.0
